        ...
        return (
            <section className="portfolioHomeAttr" >
                ...
                <p className="connectbox">
                    <input className="" type="button" value="Connect Your Wallet" onClick={() => { this.ConnectMetaMask(); this.handleConnectYourWallet(); }} />
                </p>
                <Row>

                    <Col lg="5" style={{ display: "inline-block", paddingLeft: "120px" }}>
                        <p style={{ color: "#fafafa", fontSize: "24px", paddingLeft: "100px" }}>The level of profitability only possible with liquidity mining</p>
                        <p style={{ paddingLeft: "100px", paddingBottom: "24px", paddingTop: "44px" }}>
                            <span >
                        ...
                        <p style={{ paddingLeft: "100px", paddingBottom: "24px" }}>
                            <span >
                                <img src="images/eth_dollar.png" alt="eth_dollar" height="40px" />
                            </span>
                            <span className="eth_usdt_pair_initial">
