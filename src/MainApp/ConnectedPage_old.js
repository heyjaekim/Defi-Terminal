...
import { StakeTogglerAnimationBox, GasSpeedAnimationBox, PercentAnimationBox, styles, menuHamber } from "../components/styles";
...
class ConnectedPage extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            allocOverflowDet: [],
            totalTradeSize: 0, /* 각 Sub Size Token 값들의 합을 Trade Size에 자동 업데이트하는 state variable*/
            speed: "slow",
            token1: 0,   /*                             */
            token2: 0,   /*                             */
        ...
        this.gasSpeed = props.gasSpeed;
        this.testTokenData = props.testTokenData;
    };
    ...
    handleToken1Change = async (evt) => {
        ...
        this.setState({
            token1: token1,
            totalTradeSize: trade_size
        });
        console.log("handleToken1Change", trade_size, token1, this.state.token1, this.state.totalTradeSize);
    };
    ...
    removeTokenData = async () => {
        // const { tokenData } = this.state;
        // this.setState({
        //     tokenData: tokenData.slice({ t_id: this.state.t_id--})
        // })
        ...
        return (
            <React.Fragment>
                {/* <div className="App">
                    ...
                    <CustomizedSlider onChange={this.handlePercent}/>
                </div> */}
                <div className="home">
                    <section className="home-attr" id="home">
                            ...
                            <div className="basic-info-tab">
                                ...
                                <button href="#" className="active" value={true}
                                    onClick={(e) => {
                                        ...
                                        this.StakeTogglerAnimation(true, e.target);
                                    }}>Stake</button>
                                <button href="#" className="disable" value={false}
                                    onClick={(e) => {
                                        this.SetStake(false);
                                        this.setDetailAreaUnstake();
                                        this.StakeTogglerAnimation(false, e.target);
                                    }}>Unstake</button>
                            </div>
                        </Row>
                            ...
                            <div className="text-information-area">
                                <Row>
                                    <div className="trade-size" id="stake_trade">
                                        ...
                                        <input className="stake_tradesize_manual" type="number" value={this.state.totalTradeSize} />
                        ...
                        <Row>
                            <div className="wallet-connected">
                                ...
                                <div className="trading-rows-unstake" id="trading_rows_unstake">
                                    <Row>
                                        <h5 className="context1">Liquidity Pools</h5>
                                        <h5 className="context2">LP Token Amount</h5>
                                        <h5 className="context3">Withdrawal Percentage</h5>
                                        <h5 className="context3">Address</h5>
                                    </Row>
                                </div>
                            </div>
                        ...
                        {mapToTestTokenUnstake(this.state.tokenData)}
                            ...
                            <div className="eth-usdt-row">
                                ...
                                <div className="eth_token_size">
                                    ...
                                    <div className="percent_area">
                                        ...
                                        <button type="button" id="percent0"
                                            onClick={(e) => { this.SetPercent(0); this.percentAnimation(0, e.target); }}>0%</button>
                                        <button type="button" id="percent25"
                                            onClick={(e) => { this.SetPercent(25); this.percentAnimation(25, e.target); }}>25%</button>
                                        <button type="button" id="percent50"
                                            onClick={(e) => { this.SetPercent(50); this.percentAnimation(50, e.target); }}>50%</button>
                                        <button type="button" id="percent75"
                                            onClick={(e) => { this.SetPercent(75); this.percentAnimation(75, e.target); }}>75%</button>
                                        <button type="button" id="percent100"
                                            onClick={(e) => { this.SetPercent(100); this.percentAnimation(100, e.target); }}>100%</button>
                                    </div>
                                    <div className="address">
                                        <input className="address-input" type="text" name="" onChange={(e) => { this.handleDisplayPairImg(); 
